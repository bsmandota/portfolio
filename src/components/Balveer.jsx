...
function FadeIn({ children }) {
  ...
  return (
    <div
      ref={ref}
      className="fade-in duration-2000"
    >
      {children}
    </div>
  );
...
function Balveer() {
  const [Balveer, setBalveer] = useState("Balveer");
  const textList = ["Coder", "Programmer", "Developer", "Designer"];
  ...
  return (
    <div className="bg-blue-300">
      <div className="h-screen bg-gradient-to-r from-black via-blue-900 to-white ">
        <nav
          className={`h-12 p-10 flex z-50 justify-between text-center items-center text-lg shadow-lg bg-slate-700 text-white fixed top-0 w-full transition-transform duration-300  ${
            show ? "" : "transform -translate-y-full"
          }`}
        >
          <h1 className=" text-3xl self font-bold p-0 cursor-default">
            Balveer
          </h1>
          <div className="flex justify-end hover:text-slate-400 ">
            <a
              onClick={() => Goto(homeRef)}
              className="hover:text-white p-6 duration-300 cursor-pointer nav-items"
            >
              Home
            </a>
            <a
              onClick={() => Goto(aboutMeRef)}
              className="hover:text-white p-6 duration-300 cursor-pointer nav-items"
            >
              About Me
            </a>
            <a
              onClick={() => Goto(resumeRef)}
              className="hover:text-white p-6 duration-300 cursor-pointer nav-items"
            >
              Resume
            </a>
        ...
        <div
          ref={homeRef}
          className="flex w-screen top-[100vh] absolute -translate-y-[100%] justify-start items-center text-white right-0 pointer-events-none"
        >
          <div className="min-w-[50%]">
            <div className=" h-full inline-block relative ml-8">
              <h1 className="text-4xl font-extrabold my-3t">Hey!</h1>
              <h1 className="h-20 text-8xl font-extrabold text-left">
                I'm {Balveer !== "Balveer" && "a"}
              </h1>
              <h1
                key={Balveer}
                style={{
                  animation: `type 2s steps(${Balveer.length}), wipe 1s 4s, cursor 0.5s infinite`,
                }}
                className=" border-collapse text my-10 pb-3 -pt-2 text-8xl font-extrabold overflow-hidden"
              >
                {Balveer}
              </h1>
            </div>
          </div>
          <div className=" flex h-full justify-end items-end w-1/2 min-w-[50%] max-w-1/2 ">
            <img src={Photo} className="h-[50rem] w-auto" alt="selfImage" />
          </div>
        </div>
      </div>
      {/* <div ref={ref} className="min-h-screen w-full group bg-gray-800">
        <div className="bg-tranparent pointer-events-none text-transparent top-0 h-full w-full group-hover:bg-lime-900 group-hover:pointer-events-auto overflow-y-hidden group-hover:text-black duration-1000">
          <h1 className="text-5xl font-bold text-center w-full">Projects</h1>
          <div className="flex h-full w-full justify-center items-center absolute">
            <div className="h-1/2 w-60 inline shadow-lg bg-yellow-500 m-5 p-4"></div>
            <div className="h-1/2 w-60 inline shadow-lg bg-green-500 m-5 p-4"></div>
            <div className="h-1/2 w-60 inline shadow-lg bg-blue-500 m-5 p-4"></div>
            <div className="h-1/2 w-60 inline shadow-lg bg-red-500 m-5 p-4"></div>
          </div>
        </div>
        </div> */}
      <FadeIn>
        <div ref={aboutMeRef} className="min-h-screen w-full group bg-gray-800">
          <h1 className="text-5xl font-bold text-center w-full">About me</h1>
        </div>
      </FadeIn>
      <FadeIn>
        <div ref={resumeRef} className="min-h-screen w-full group bg-red-800">
          <h1 className="text-5xl font-bold text-center w-full">Resume</h1>
        </div>
      </FadeIn>
      <FadeIn>
        <div ref={skillsRef} className="min-h-screen w-full group bg-yellow-800">
          <h1 className="text-5xl font-bold text-center w-full">Skills</h1>
          <div className=" h-full w-screen flex-wrap justify-around grid grid-cols-3">
            <span className="h-24 m-4 w-24 animate bounce min-w-1/ shadow ">
            ...
            <span className="h-24 m-4 w-24 animate bounce min-w-1/4 shadow ">
              <svg viewBox="0 0 128 128">
                <path
                  fill="#cb3837"
      ...
      <FadeIn>
        <div ref={projectsRef} className="min-h-screen w-full group bg-blue-800">
          <div className="bg-tranparent pointer-events-none text-transparent top-0 h-full w-full group-hover:bg-lime-900 group-hover:pointer-events-auto overflow-y-hidden group-hover:text-black duration-1000">
            <h1 className="text-5xl font-bold text-center w-full">Projects</h1>
            <div className="flex h-full w-full top-full group-hover:top-auto justify-center items-center absolute duration-500 ">
              <div className="h-1/2 w-60 inline shadow-lg bg-yellow-500 m-5 p-4"></div>
              <div className="h-1/2 w-60 inline shadow-lg bg-green-500 m-5 p-4"></div>
              <div className="h-1/2 w-60 inline shadow-lg bg-blue-500 m-5 p-4"></div>
              <div className="h-1/2 w-60 inline shadow-lg bg-red-500 m-5 p-4"></div>
      ...
      <FadeIn>
        <div ref={contactRef} className="min-h-screen w-full group bg-green-800">
          <h1 className="text-5xl font-bold text-center w-full">Contacts</h1>
        </div>
      </FadeIn>
    </div>
  );
